...
const Hero = () => {
  return (
    <section
      id="hero"
      className="relative mt-8 py-20 lg:py-32 bg-gradient-to-br from-card to-background"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-xl leading-relaxed text-muted-foreground opacity-0 animate-fadeInUp delay-200">
            Delivering premium marble, granite, and industrial solutions for
            iconic projects across KSA & GCC
          </p>
